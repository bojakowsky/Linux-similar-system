...
void sop::processor::Module::initialize()
{
  ...
  shell->registerCommand("quanttime",&ExecutiveUnit::cH_showQuantTimeLeft,(this->ExUnit));
  ...
  shell->registerCommand("startProcess",&ExecutiveUnit::cH_addProcess, (this->ExUnit));
