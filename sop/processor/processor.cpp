...
//REU
void sop::processor::ProcessorHandler::REBbut16(processor *proc)
{
  std::cout<<"____INPUT____\n"; 
  uint16_t input;
  std::cout << "Program is reading input data: "<< std::endl;
  proc->age--;
  std::cin>>input;
